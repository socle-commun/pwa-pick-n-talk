...
export default function BinderCard({ binder, className, ...props }: { binder: TranslatedBinder; className?: string }) {
  ...
  return (
    ...
    >
      <Button href={`/${binder.uuid}`} plain className={cn("flex flex-col gap-1 bg-transparent rounded-b-none")}>
        ...
        <div className={cn("pl-1 text-sm italic text-zinc-700 dark:text-zinc-300")}>
          {t("by")} {binder.author}
        </div>
