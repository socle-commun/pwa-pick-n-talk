...
import { MenuItem, Select, FormControl, InputLabel, Box, type SelectChangeEvent, type SxProps, type Theme } from "@mui/material";
...
export default function DaltonismModeToggle(_props: DaltonismModeToggleProps) {
  ...
  const handleDaltonismChange = (event: SelectChangeEvent<string>) => {
