      ...
      <div className={"container mx-auto px-4 py-8 max-w-6xl"}>
        ...
        {hasNoBinders ? (
          ...
          <div className={"text-center py-12"}>
            ...
            <Button href="/binders/create" className={"px-8 py-3"}>
  ...
  return (
    <div className={"container mx-auto px-4 py-8 max-w-6xl"}>
      ...
      <section className={"text-center py-12 mb-16"}>
        ...
        <Heading level={1} className={"text-4xl lg:text-5xl mb-6"}>
        ...
        <div className={"flex flex-col sm:flex-row gap-4 justify-center"}>
          <Button href="/auth/sign-up" className={"px-8 py-3"}>
            {t("homepage.hero.cta.primary")}
          </Button>
          <Button href="#features" outline className={"px-8 py-3"}>
